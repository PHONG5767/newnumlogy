const circleContent = {
  decription22: ` Life Path 22s are powerful manifestors, and if they are willing to work hard on what they desire they can achieve enormous prestige, success and fame.
  ...
  These people are inherently fairly-minded, diplomatic and generous, with a desire to…`,
  decription1: ` 
...
const accordion = {
  content0: `According to the beliefs of Numerology, the dominant number is like the roof that covers each person's life. Through the dominant number, Numerology deciphers the mysteries of oneself, such as one's life path, prominent characteristics, strengths, limitations, suitable occupations, whether we are heading in the right direction, and how to make adjustments.  Can we change our direction? How can we adjust it?... You can discover your dominant number by checking the free numerology on the specialized ...`,
  content1: `Our birth date chart is likened to a piece of land that the universe has entrusted to each individual as their capital in this life. Based on the numerical value of your birth date, we can create a chart that shows the presence or absence of certain numbers in specific positions.

  Through the analysis of this birth date numerology, it can help you visualize in detail your distinctive personality traits, how your life will unfold, the lessons that life has bestowed upon you, and ways for you to overcome them...`,
  content2: `The characteristic arrow represents the distinctive and prominent traits of an individual on the birth date chart. The characteristic arrow consists of three numbers aligned horizontally, vertically, or diagonally. Each characteristic arrow will have its own unique characteristics...`,
  content3: `The four pinnacles of human life, from the perspective of numerology, are similar to the peaks of a combination of four pyramids. Through these pinnacles, you can understand when you will enter different stages of maturity, the nature of the high points in your life, and more. It helps you comprehend your purpose in this world and fulfill it in the best possible way...`,
  content4: `Mission Number: The mission number is the number derived from each individual's given name. In our lives, each person has a unique given name. According to numerology, a name holds not only the identification of an individual but also contains many distinct meanings.
  Personality Number:    The personality number reflects how others perceive you through your reactions, choices, thoughts, words, and actions.
  Soul Number:    The soul number is a number that represents deep desires within a person. It reveals what truly satisfies and fulfills you.
  Attitude Number:    This number represents the attitude and instinctive (immediate) response to a situation, especially in initial encounters...`,
  content5: `Career orientation according to numerology is like a compass guiding each person's future. By exploring numerology online, you can discover your strengths and weaknesses, which can help you choose a career that aligns with your true self...`,
};
const getlink = {
...
const BirthdayNumber = {
  ...
  num3: ` If you were born on the third day of the month, your life is filled with an abundance of creativity and a desire to bring beauty and joy into the world. You have a unique and imaginative perspective that sets you apart from others. Repetitive or mundane tasks do not satisfy you; you seek to uncover the deeper meaning and beauty in everything you do.
  ...
  In summary, being born on the fourth day of the month bestows upon you a sense of responsibility, reliability, and practicality. Embrace your strong work ethic, attention to detail, and problem-solving abilities. Cultivate a balance between structure and creativity, and remember to take time for self-care and enjoyment. Your steadfast nature and dedication will lead you to success in all aspects of life.`,
  num5: ` If you were born on the fifth day of the month, your life is characterized by a heightened sense of adventure, curiosity, and a desire for freedom. You possess a natural affinity for exploration and an insatiable wanderlust that drives you to seek new experiences and embrace the world around you.
  ...
  num7: ` If you were born on the seventh day of the month, your life is characterized by shrewdness, precision, and a meticulous approach to understanding the world around you. You possess a deep desire for knowledge, seeking to unravel the mysteries of life and gain a deeper understanding of the universe.
  ...
  num12: `If you were born on the twelfth day of the month, your life is characterized by a harmonious blend of creativity, intuition, and nurturing energy. You possess a natural ability to connect with others on a deep emotional level and bring harmony to your relationships and surroundings.
  ...
  num13: `If you were born on the thirteenth day of the month, your life is marked by a unique combination of determination, resilience, and adaptability. You possess a strong sense of individuality and have the ability to overcome challenges with grace and strength.
  ...
  num14: `If you were born on the fourteenth day of the month, your life is characterized by a harmonious blend of practicality, creativity, and a strong sense of responsibility. You possess a unique combination of analytical thinking and artistic expression, making you a well-rounded individual.
  ...
  num15: `If you were born on the fifteenth day of the month, you possess a dynamic and versatile nature that thrives on embracing change and seeking new experiences. Your life is characterized by a constant flow of energy and a deep desire for freedom and exploration.
  ...
  Overall, your Birth Day Number 15 gifts you with the qualities of leadership, adaptability, and a thirst for freedom. Embrace your dynamic nature and use it to explore new horizons and inspire others. Seek out experiences that ignite your passion and allow your adventurous spirit to soar. With a balance of freedom and stability, you can create a life filled with growth, fulfillment, and endless possibilities.`,
  num16: `If you were born on the sixteenth day of the month, you possess a harmonious blend of practicality and spirituality. Your life is guided by a deep sense of purpose and a strong connection to the spiritual realm.
  ...
  Overall, your Birth Day Number 16 gifts you with a unique blend of practicality and spirituality. Embrace your leadership qualities, your nurturing nature, and your deep spiritual connection. Use these gifts to create a life of purpose, compassion, and personal growth. Strive to bring harmony to all aspects of your life and inspire others with your balanced approach.`,
  num17: `If you were born on the seventeenth day of the month, you possess a powerful combination of strength, ambition, and intuition. Your life is marked by a drive for success, a thirst for knowledge, and a deep understanding of the world around you.
  ...
  Overall, your Birth Day Number 17 gifts you with a unique combination of ambition, intuition, and leadership. Embrace your strengths, trust your instincts, and pursue your dreams with determination. Use your knowledge and insights to make a positive impact in the world and inspire others to reach their full potential. Strive for personal growth, while also nurturing your inner wisdom and well-being.`,
  num18: `If you were born on the eighteenth day of the month, you possess a harmonious blend of ambition, practicality, and compassion. Your life is characterized by a strong sense of responsibility, a drive for success, and a deep desire to make a positive difference in the world.
  ...
  num19: `If you were born on the nineteenth day of the month, you possess a powerful blend of independence, leadership, and humanitarianism. Your life is characterized by a strong sense of purpose, a drive for personal growth, and a deep desire to contribute to the greater good.
  ...
  Overall, your Birth Day Number 20 gifts you with a harmonious and diplomatic nature. Embrace your ability to create balance, nurture relationships, and find common ground. Use your creativity and adaptability to navigate through life's challenges and inspire others. Trust your intuition and let it guide you towards fulfilling your purpose. With your harmonious and diplomatic spirit, you have the potential to create a world of understanding, cooperation, and connection.`,
  num21: `If you were born on the twenty-first day of the month, you possess a dynamic and charismatic nature that shines brightly in any situation. Your life is characterized by a combination of creativity, ambition, and a natural ability to inspire and lead others.
  ...
  Overall, your Birth Day Number 21 gifts you with a dynamic and charismatic nature. Embrace your creativity, ambition, and natural leadership abilities. Use your magnetic presence to inspire and uplift others. Trust your intuition and let it guide you towards fulfilling your purpose. With your unique blend of sensitivity and confidence, you have the potential to create a life filled with success, creativity, and meaningful connections.`,
  num22: `If you were born on the twenty-second day of the month, you possess a remarkable blend of practicality, ambition, and spiritual insight. Your life is characterized by a deep sense of purpose, a strong desire for achievement, and a unique ability to manifest your dreams into reality.
  ...
  Overall, your Birth Day Number 22 gifts you with a unique blend of practicality, ambition, and spiritual insight. Embrace your role as a visionary leader and use your abilities to manifest your dreams and make a positive impact in the world. Trust in your intuition, stay focused on your goals, and let your journey be guided by your higher purpose. With your remarkable combination of skills and qualities, you have the potential to create a life of extraordinary success and spiritual fulfillment.`,
  num23: `If you were born on the twenty-third day of the month, you possess a creative and expressive nature that thrives on embracing the beauty and meaning of life. Your life is characterized by a deep sense of intuition, artistic flair, and a natural inclination towards spiritual exploration.
  ...
  Overall, your Birth Day Number 24 gifts you with a nurturing and responsible nature that contributes to creating harmonious relationships and environments. Embrace your caring instincts and use them to provide support and guidance to others. Cultivate strong foundations in all areas of your life and nurture the relationships that bring you joy and fulfillment. Your ability to create a sense of stability and harmony makes a positive impact on the lives of those around you.`,
  num25: `If you were born on the twenty-fifth day of the month, you possess a curious and adventurous nature that thrives on exploring new horizons and seeking diverse experiences. Your life is characterized by a constant quest for knowledge, a desire for personal growth, and a deep connection to your intuition.
  ...
  num28: `If you were born on the twenty-eighth day of the month, you possess a unique blend of ambition, creativity, and a desire for recognition. Your life is characterized by a strong drive to achieve success and make a lasting impact in your chosen endeavors.
  ...
  Overall, your Birth Day Number 28 gifts you with a unique blend of ambition, creativity, and a desire for recognition. Embrace your ambition and channel it towards meaningful pursuits. Let your creativity shine and continue to make a lasting impact in your chosen endeavors. Seek balance in all aspects of your life, and celebrate your achievements along the way.`,
  num29: `If you were born on the twenty-ninth day of the month, you possess a compassionate and idealistic nature that is driven by a deep desire to make a positive impact in the world. Your life is characterized by a strong sense of empathy, a thirst for knowledge, and a mission to bring about meaningful change.
  ...
  num31: `If you were born on the thirty-first day of the month, you possess a unique and dynamic nature that combines the qualities of leadership, creativity, and a deep sense of intuition. Your life is characterized by a blend of ambition, artistic expression, and a profound connection to your inner wisdom.
...
const SecondChallenge = {
  num1: `The Second Challenge Number 1 represents the challenge of building and maintaining relationships. Individuals with a Second Challenge Number of 1 may struggle with self-confidence, effective communication, and establishing harmonious connections with others. They may find it challenging to assert their needs, express their emotions, or strike a balance between independence and collaboration.
  ...
  num2: `The Second Challenge Number 2 represents the challenge of decision-making, independence, and self-confidence. Individuals with a Second Challenge Number of 2 may struggle with making choices, asserting their independence, and trusting their own judgment. They may rely too heavily on others' opinions and seek validation externally, leading to a lack of self-assurance.
  ...
  num6: `The Second Challenge Number 6 represents the challenge of cultivating harmonious and fulfilling relationships. Individuals with a Second Challenge Number of 6 may struggle with codependency, seeking validation from others, or finding balance between their own needs and the needs of their loved ones. They may face difficulties in setting healthy boundaries and maintaining healthy dynamics in their relationships.
...
const ThirdChallenge = {
  num1: `The Third Challenge Number 1 signifies the challenge of expressing creativity and personal freedom. Individuals with a Third Challenge Number of 1 may encounter difficulties in fully embracing their creative potential, expressing their ideas, or stepping outside of societal norms. They may struggle with self-criticism, fear of failure, or a sense of limitation in their creative pursuits.
  ...
  num4: `The Third Challenge Number 4 signifies the challenge of embracing change and adaptability. Individuals with a Third Challenge Number of 4 may encounter difficulties in embracing new opportunities, adapting to unexpected situations, or letting go of rigid beliefs or routines. They may resist change, fear uncertainty, or struggle with flexibility.
  ...
  num6: `The Third Challenge Number 6 signifies the challenge of expressing unconditional love and compassion. Individuals with a Third Challenge Number of 6 may struggle with self-judgment, perfectionism, or difficulty in accepting themselves and others as they are. They may have high expectations and find it challenging to embrace imperfections and mistakes.
  ...
  num8: `The Third Challenge Number 8 signifies the challenge of maintaining a healthy work-life balance and nurturing personal relationships. Individuals with a Third Challenge Number of 8 may find it difficult to prioritize their personal lives, relationships, and well-being amidst their ambitious pursuit of success. They may face challenges in creating harmony between their professional and personal spheres.
...
const FourthChallenge = {
  ...
  Remember, the Challenge Numbers in Numerology provide valuable insights into the specific challenges individuals may encounter on their life paths. Each challenge offers an opportunity for personal growth, self-reflection, and the development of essential skills. By embracing these challenges and working towards overcoming them, individuals can navigate their lives with greater resilience, balance, and fulfillment.  `,
  num6: `The Fourth Challenge Number 6 represents the challenge of creating a sense of stability and harmony in the home and family life. Individuals with a Fourth Challenge Number of 6 may struggle with conflicts, disorganization, or difficulties in creating a nurturing and harmonious environment. They may face challenges in balancing work and family responsibilities.
  ...
  num8: `The Fourth Challenge Number 8 represents the challenge of embracing change and adapting to new circumstances. Individuals with a Fourth Challenge Number of 8 may resist change, feel overwhelmed by transitions, and struggle to embrace new opportunities. They may find it challenging to let go of control and adapt to the evolving demands of life.
...
const ChallengeNumbersContent = {
  content: `
  "The Challenge Numbers" in Numerology are an important aspect of analyzing and understanding an individual's life and personality. They refer to the challenges that a person may encounter in life and how they can overcome these challenges to achieve growth and progress.
...
First Challenge: Represents the difficulties and challenges in self-expression, exploration, and personal development. Individuals with the First Challenge often have to overcome self-doubt and fear to discover their potential.

Second difficulties and challenges in building and maintaining relationships. Individuals with the Second Challenge often have to overcome self-doubt and communication difficulties to create balance and harmony in relatiships.

Third Challenge: Represents the difficulties and challenges in expressing creativity and personal freedom. Individuals with the Third Challenge often have to overcome self-criticism and difficulties in expressing themselves and their ideas.

Fourth Challenge: Represents the difficulties and challenges in building a solid and stable foundation in life. Individuals with the Fourth Challenge often have to overcome difficulties in organizing and managing their lives, and they have to work hard to achieve success.
`,
};
const FirstPeriodCycle = {
  num1: `
  First Period Cycle: The First Period Cycle is a significant phase that spans from birth to around the age of 27. It represents the formative years of your life, where you lay the foundation for your future endeavors. During this cycle, you undergo a journey of self-discovery, personal growth, and the development of your individuality. It is a time when you explore your identity, discover your passions and talents, and learn to stand on your own two feet.
  ...
  num3: `
  First Period Cycle: The First Period Cycle spans from birth to around the age of 27 and represents a time of self-discovery, exploration, and personal growth. During this cycle, you embark on a journey to uncover your true identity, express your creativity, and develop your unique talents and abilities.
  ...
  num4: `First Period Cycle: The First Period Cycle encompasses the early years of your life, from birth to around the age of 27. It is a foundational phase focused on establishing stability, structure, and a solid groundwork for your future endeavors.
  ...
  num5: `First Period Cycle: The First Period Cycle represents the early stages of your life, from birth to around the age of 27. It is a time of exploration, freedom, and growth, where you experience a variety of opportunities and challenges that shape your individuality.
  ...
  Throughout the First Period Cycle, you may encounter challenges related to freedom, making choices, and embracing uncertainty. You may need to overcome fears of the unknown, indecisiveness, or a tendency to resist change. This cycle pushes you to develop resilience, flexibility, and the ability to navigate through life's transitions.`,
  num6: `
  First Period Cycle: The First Period Cycle represents the initial phase of your life, starting from birth and extending until around the age of 27. It is a time of personal development, responsibility, and nurturing relationships.
  ...
  num7: `First Period Cycle: The First Period Cycle represents the initial phase of your life, starting from birth and extending until around the age of 27. It is a time of self-discovery, introspection, and spiritual growth.
  ...
  Throughout the First Period Cycle, you may encounter challenges related to self-reflection, finding your true purpose, and balancing your intellectual pursuits with practical matters. You may need to overcome a tendency to overanalyze or become detached from your emotions. This cycle invites you to embrace your intuitive nature, trust your inner guidance, and cultivate a deeper sense of spirituality.`,
  num8: `First Period Cycle: The First Period Cycle spans from birth to around the age of 27 and represents a phase of personal development, ambition, and material success.
  ...
  Throughout the First Period Cycle, you may encounter challenges related to building financial stability, managing responsibilities, and balancing work and personal life. You may need to overcome self-doubt, fear of failure, or a tendency to become overly focused on material gain. This cycle invites you to harness your inner strength, embrace opportunities for growth, and develop a strong work ethic.`,
  num9: `
  First Period Cycle: The First Period Cycle spans from birth to around the age of 27 and represents a phase of self-discovery, humanitarianism, and spiritual growth.
  ...
  Throughout the First Period Cycle, you may encounter challenges related to personal growth, finding your true calling, and navigating your own emotions. You may need to overcome self-doubt, self-centeredness, or a tendency to become overwhelmed by the suffering of others. This cycle invites you to embrace your innate wisdom, practice selflessness, and contribute to the well-being of others.`,
};
const SecondPeriodCycle = {
  num1: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase characterized by stability, balance, and the nurturing of relationships. During this cycle, you focus on creating harmonious connections, fostering cooperation, and finding a sense of equilibrium in your personal and professional life.
  ...
  num3: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase focused on nurturing relationships, establishing emotional connections, and finding balance in your interactions with others.
  ...
  During the Second Period Cycle, you may encounter challenges related to relationships, communication, and maintaining emotional balance. You may need to overcome barriers such as fear of vulnerability, difficulty expressing your emotions, or challenges in resolving conflicts peacefully. By cultivating effective communication skills, practicing compassion, and nurturing healthy relationships, you can navigate these challenges and create fulfilling connections with others.`,
  num4: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase focused on building upon the foundation you established during the first cycle and further developing your personal and professional life.
  ...
  During the Second Period Cycle, you may encounter challenges related to managing responsibilities, balancing work and personal life, or adapting to changing circumstances. You may need to overcome hurdles such as perfectionism, resistance to change, or fear of taking risks. This cycle urges you to find a harmonious equilibrium between stability and growth.`,
  num5: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase of stability, responsibility, and establishing a sense of personal security and fulfillment.
  ...
  During the Second Period Cycle, you may face challenges related to relationship dynamics, setting boundaries, or finding emotional balance. You may need to overcome a fear of intimacy, people-pleasing tendencies, or a need for external validation. This cycle invites you to prioritize self-love, cultivate healthy relationships, and create a harmonious and supportive environment.`,
  num7: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and continues until around the age of 54. It is a phase of self-exploration, personal growth, and deeper spiritual understanding.
  ...
  During the Second Period Cycle, you may face challenges related to self-discovery, finding meaning in life, and maintaining a balance between the material and spiritual realms. You may need to overcome a fear of the unknown, skepticism, or a tendency to isolate yourself. This cycle invites you to embrace spiritual practices, seek wisdom from various sources, and find harmony between the physical and spiritual aspects of your life.`,
  num8: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase of refinement, wisdom, and the pursuit of higher goals.
  ...
  During the Second Period Cycle, you may face challenges related to managing power and authority, balancing personal and professional responsibilities, or overcoming obstacles in your path to success. You may need to develop effective leadership skills, cultivate resilience, and maintain a healthy work-life balance. This cycle invites you to embrace your leadership potential, align your actions with your values, and strive for excellence in all aspects of your life.`,
  num9: `Second Period Cycle: The Second Period Cycle begins around the age of 28 and extends until around the age of 54. It is a phase of service, harmony, and deepening connections with others.
  ...
  During the Second Period Cycle, you may face challenges related to boundaries, codependency, or finding balance in your relationships. You may need to develop healthy communication skills, practice self-care, and maintain emotional balance. This cycle invites you to embrace the power of love, nurture your relationships, and bring harmony to your interactions with others.`,
};
const ThirdPeriodCycle = {
  num1: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues until the end of your life. It is a phase of self-expression, creativity, and spiritual growth. During this cycle, you have the opportunity to tap into your creative potential, express yourself authentically, and embrace your inner wisdom.
  ...
  Each Period Cycle brings its own set of experiences, lessons, and opportunities for growth. By understanding and embracing the energies of each cycle, you can navigate through life's challenges with greater clarity, purpose, and fulfillment. Remember, these cycles are not rigid timelines but rather guides that assist you in understanding the predominant themes and energies that influence different stages of your life.`,
  num2: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues until the end of your life. It is a phase of self-expression, creativity, and spiritual growth. During this cycle, you have the opportunity to tap into your creative potential, express yourself authentically, and embrace your inner wisdom.
  ...
  Each Period Cycle offers unique opportunities for growth and self-discovery. By understanding the energies associated with each cycle, you can navigate through life's challenges with grace, cultivate harmonious relationships, and express your authentic self in a way that brings joy and fulfillment to your life and those around you.`,
  num3: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues throughout the rest of your life. It is a phase focused on wisdom, spiritual growth, and sharing your experiences and insights with others.
  ...
  Each Period Cycle presents its own set of challenges and opportunities for growth. By understanding the energies associated with each cycle and embracing the lessons they offer, you can navigate through life with greater self-awareness, creativity, and fulfillment.`,
  num4: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues throughout the rest of your life. It is a phase focused on wisdom, introspection, and the pursuit of inner fulfillment.
  ...
  Each Period Cycle offers unique opportunities for growth and challenges to overcome. By understanding the energies associated with each cycle and embracing the lessons they present, you can navigate through life with resilience, purpose, and a solid foundation for success.`,
  num5: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues throughout the rest of your life. It is a phase of self-expression, creativity, and personal transformation.
  ...
  Each Period Cycle offers a unique set of experiences and challenges that contribute to your personal growth and development. By understanding and embracing the energies associated with each cycle, you can navigate through life with a sense of adventure, adaptability, and the freedom to express your true self.`,
  num6: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and extends throughout the rest of your life. It is a phase of creativity, self-expression, and spiritual growth.
  ...
  Each Period Cycle offers valuable opportunities for personal growth, self-discovery, and the cultivation of meaningful relationships. By understanding and embracing the energies associated with the number 6, you can navigate through life with love, harmony, and a deep sense of purpose.`,
  num7: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and extends throughout the rest of your life. It is a phase of spiritual mastery, wisdom, and a deeper connection to the divine.
  ...
  Each Period Cycle offers unique opportunities for personal and spiritual growth. By understanding and embracing the energies associated with the number 7, you can navigate through life with greater clarity, intuition, and a deep connection to your higher self and the universe.`,
  num8: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues throughout the rest of your life. It is a phase of wisdom, philanthropy, and leaving a legacy.
  ...
  Each Period Cycle offers unique opportunities for growth, self-discovery, and the realization of your potential. By understanding and embracing the energies associated with the number 8, you can navigate through life with purpose, ambition, and a commitment to creating a prosperous and meaningful existence.`,
  num9: `Third Period Cycle: The Third Period Cycle begins around the age of 55 and continues throughout the rest of your life. It is a phase of spiritual transformation, wisdom, and the pursuit of higher consciousness.
...
const ExpressionnumberName = {
  ...
  num6: `Sixes and twos are quite a bit alike in terms of their tendencies to place others way ahead of themselves. Sixes, however, find it easier to take sides and assert their own positions. They will side with anyone they believe to be the victims of injustice, prejudice or circumstance. As a 6, your idealistic nature does work very much in your favor when applied to matters of productivity. You know how to get things done and you have no problem feeling proud of yourself. You may have unexplored talents and some of them may never fully manifest. That is not to say that you should not pursue any talent or ability you have – you should! You may simply decide that there are other areas of life that take precedent and that is fine as well.
    ...
    As you get older, you may find yourself gathering things around you that make you feel good. You need to be careful not to overspend on luxuries as you will develop a tendency to cling to things more than people. In the long run, people matter more so work on maintaining your focus.`,
...
const HeartDesireNumberContent = {
  num1: `You have an insatiable need for independence. You are determined to be the master of your own destiny. You are determined to live life on your terms. You not only have leadership qualities, but in many situations consider yourself to be the only qualified leader. This instills you with confidence and helps you make difficult decisions that others would be apprehensive about making
  ...
  The negative in all this is that the things you know about yourself and your abilities can make you come across as arrogant or domineering. Be sure to gather around you people who want to be led. Competition can bring out parts of your personality best left out of public view.`,
  num2: `You want all the facets of your life to revolve around peace, harmony and balance. You are a person of unwavering devotion. This applies to all areas of your life as well, and to all your relationships. Your perpetually heightened emotional state can make you extremely sensitive. You may have extreme emotional reactions to art, music, movies, stories, etc.
  ...
  num3: `You are the life of the party – happy, outgoing, and very personable. People find you inspiring and entertaining and your self-expression skills show themselves in your words. Some people hang on your words but you need to be careful not to over-use your words. You have the tendency to run off at the mouth quite a bit when you are nervous or experiencing an abundance of ego. Those words of yours would be best served in avenues like writing, acting and public speaking.

  You are extremely creative so find an appropriate outlet for your creativity. Those abilities will need to be reined in if you are going to make best use of them. Without focus, you have a tendency to become disorganized and that could leave some of your talents severely under-utilized.`,
  num4: `You have a need for stability and structure in your life. You want your life and everything that touches it to be orderly. You have a systematic way of doing virtually everything. You are often not satisfied unless you are working toward some kind of goal. This makes you focus too heavily on work at times so remember that stability also means having time for yourself. “All work and no play” is not a recipe for structure or stability.
  ...
  num5: `Freedom is an essential element for your happiness to be complete. You love traveling, seeing new places, meeting new people, trying new things. Whenever a new idea comes to you, it gets you excited and your enthusiasm is infectious. This is a valuable leadership ability and one that you must work to continually cultivate and develop.
...
const PersonalityNumberContent = {
  ...
  num3: `YMost people with a Personality Number of 3 are exceptionally attractive. When it occurs in the Outer Personality Number it generally denotes physical beauty. In the minor number it denotes inner beauty and confidence in one's appearance.
  ...
  num6: `You have a gift of true compassion so you likewise attract people who are in need of comfort or an empathetic shoulder. You care about their issues and suffer with them whenever they hurt or suffer injustice. Many Personality sixes are also empaths (those who literally sense the emotions of others, especially in areas of sadness, worry, fear or grief). For this reason it is imperative that you guard your own feelings and emotions.
  ...
  The downside to all of this is that, while many people will likely respect you, they will also find you hard to approach. They will subsequently not make many strides to get to know you, opting instead to be content knowing about you. Be careful not to cultivate the appearance of arrogance or self-absorption. This is an easy trap into which Personality sevens can fall.`,
  num8: `Your sense of inner strength is considerable but beware how that is perceived by others. You may not even know just how much influence your actions and personality can have but you hold within your grasp the ability to either build up or tear down with your words and actions. This is true in all your dealings with people from simple business transactions to serious relationships with a significant other, spouse, children or extended family. You have a tendency to be generous but you also have the tendency to size up a person's situation, attitude and trustworthiness before deciding to help them.
...
const YourKarmicLessonsContent = {
  ...
  num2: `Diplomacy and tact are not your strong suits. You will need to work on this. Be willing to be a behind-the-scenes contributor. Learn to set goals and reach them for the sake of the accomplishment more than the accolade. You don't need to be in the spotlight all the time. Work on your ability to be a team player.
  ...
  num6: `You have issues committing to anything. This is true of relationships but also work projects or maybe even a career. You come across as uncaring or emotionless. You need to let people see your range of emotions and be more demonstrative. You might often feel alone even if you have people around you who care about you and whom you love as well. You need to learn how to be sincere and communicate your feelings more effectively. Life will throw many opportunities to learn this lesson at you. Don't dodge them, face them.
...
const YourSelfNumberContent = {
  num1: `Subconscious self number 1 wants you to remind yourself of the strategies and ways to plan for the coming change. In other words, every skill can be learned based on the knowledge that you have. Mostly, every transition requires a certain skill that is updated
  ...
  `,
  num2: `Subconscious Self Number 2: Season of Good Fortune:
  ...
  `,
  num3: `Subconscious Self Number 3: True Happiness:
  ...
  `,
  num4: `Subconscious Self Number 4: Grace and Gratitude:
  ...
  `,
  num6: `Subconscious Self Number 6: Look for Better Ideas:
  ...
  `,
  num7: `Subconscious Self Number 7: Never be Satisfied:
  ...
  `,
  num8: `Subconscious Self Number 8: Transform Your life:
...
const mainNumber = {
  num1:`Core Number 1:
Strong and Leadership Personality: Individuals with the core number 1 often display strength, decisiveness, and the courage to face challenges. They have a leadership spirit and enjoy taking on leading roles in various situations.

Independence and Persistence: The number 1 represents independence and determination. People with this core number believe in their own abilities and are not afraid to confront difficulties. They can persevere in pursuing their goals and are not easily deterred by others' opinions.

Desire for Success: Core Number 1 signifies a strong desire for success and a high level of focus on their goals. They are goal-oriented and have a clear sense of what they want, which helps them progress towards success in life.

Creativity and Pioneer Spirit: Those with the core number 1 often possess a creative mindset and are pioneers in their passionate fields. They enjoy finding new solutions and are unafraid to experiment with fresh ideas.

Challenges and Limitations: Despite their abilities and potential, individuals with the core number 1 also face some limitations. They can become overly arrogant, selfish, and may not be open to considering others' opinions. This could lead to conflicts in their social relationships.

As a final piece of advice, if you have the core number 1, listen to others' opinions and learn to work effectively in a team. Openness and flexibility will help you develop and achieve sustainable success in life. Make the most of your strength and leadership abilities to steer your life towards worthy goals!
  `,
  num2:` 
  Core Number 2:
  Gentle and Introverted Personality: Individuals with the core number 2 often have a compassionate, friendly nature, and they are deeply concerned about others' emotions. They possess the ability to listen and are dedicated to their relationships.

  Sensitivity and Depth: Number 2 signifies sensitivity and the ability to understand others' thoughts and feelings. They are compassionate and often dedicated to helping others.
  
  Cooperation and Empathy: Those with this core number excel in teamwork and display high levels of empathy. They enjoy working alongside others and have a knack for resolving conflicts skillfully.
  
  Desire for Peace and Stability: Core Number 2 represents a desire for peace and stability in life. They avoid conflicts and prefer a serene and stable environment.
  
  Challenges and Limitations: Despite their warm and empathetic nature, individuals with the core number 2 also face some challenges. They can become overly shy and easily influenced by others' opinions, which may lead to indecisiveness.
  
  As a final piece of advice, if you have the core number 2, cherish your gentle nature and exceptional teamwork skills. However, focus on developing self-confidence and decisiveness to overcome challenges and achieve your goals in life. Use your compassion to create contentment and harmony in your life and the lives of those around you! `,
  num3:`Core Number 3:
  Creative and Expressive: Individuals with the core number 3 are highly creative and have a natural flair for self-expression. They excel in various forms of art, communication, and enjoy sharing their ideas and emotions with others.

Optimistic and Enthusiastic: Number 3 signifies an optimistic outlook on life. People with this core number often radiate enthusiasm and positivity, which makes them charming and likable in social settings.

Sociable and Charming: Those with the core number 3 possess excellent social skills and are charming conversationalists. They have a gift for making people feel comfortable and entertained in their presence.

Versatile and Adaptable: Core Number 3 individuals are versatile and adaptable, allowing them to navigate through different situations with ease. They embrace change and are open to new experiences.

Communication and Expression: Communication is a strong suit for those with the core number 3. They are great storytellers, performers, and have a natural ability to capture the attention of others with their words.

Thirst for Knowledge: People with the core number 3 have a curious and inquisitive nature. They enjoy learning and exploring various subjects, making them well-rounded and knowledgeable.

Challenges and Limitations: Despite their creativity and charisma, individuals with the core number 3 may sometimes struggle with scattered energies and difficulty in staying focused. They may also experience mood swings and emotional sensitivity.

As a final piece of advice, if you have the core number 3, embrace your creativity and share your talents with the world. Stay positive, open-minded, and strive to channel your energies effectively to achieve your goals. Remember to maintain focus and avoid being overwhelmed by your emotions. Utilize your gift of communication to inspire and uplift those around you!
  `,
  num4:`Core Number 4:
  Practical and Grounded: Individuals with the core number 4 have a practical approach to life. They are grounded, realistic, and prefer tangible results over fanciful ideas.

Hardworking and Determined: Number 4 signifies a strong work ethic and determination. Those with this core number are persistent and willing to put in the effort required to achieve their goals.

Dependable and Trustworthy: Core Number 4 individuals are known for their reliability and trustworthiness. They are dependable and can be counted on to fulfill their commitments.

Organized and Methodical: People with the core number 4 are naturally organized and prefer structure in their lives. They excel in planning and managing tasks efficiently.

Patient and Enduring: Core number 4 symbolizes patience and endurance. Those with this core number can handle challenging situations with composure and perseverance.

Strong Sense of Responsibility: Individuals with the core number 4 take their responsibilities seriously. They are conscientious and take pride in fulfilling their obligations.

Practical Problem-Solvers: Number 4 represents practicality and resourcefulness. People with this core number excel in finding straightforward solutions to problems.

Challenges and Limitations: Despite their stability, those with the core number 4 may sometimes struggle with being overly rigid or resistant to change. They may find it difficult to adapt to new situations or embrace spontaneity.

As a final piece of advice, if you have the core number 4, continue to embrace your practical and hardworking nature. Use your strong organizational skills to bring structure and efficiency to your endeavors. While being grounded is essential, try to remain open to change and new experiences. Balance your reliability with flexibility, and remember to take time for yourself to recharge and maintain a healthy work-life balance.
  `,
  num5:`Core Number 5:
  Freedom and Independence: Individuals with the core number 5 value their freedom and independence. They resist being tied down by restrictions and seek opportunities to explore the world on their terms.

Adventurous and Energetic: Number 5 signifies a spirit of adventure and high energy levels. Those with this core number are often drawn to exciting experiences and love to try new things.

Versatile and Adaptable: Core Number 5 individuals are highly versatile and adapt quickly to changing circumstances. They can handle diverse situations with ease.

Curious and Open-Minded: People with the core number 5 have a curious nature and an open mind. They enjoy learning and discovering new knowledge.

Charming and Sociable: Core number 5 represents a charming and sociable personality. Those with this core number have a natural ability to connect with others and make friends easily.

Restless and Impulsive: Individuals with the core number 5 may sometimes feel restless and impulsive, seeking constant stimulation and change.

Desire for Freedom and Exploration: Number 5 reflects a strong desire for freedom and a longing to explore new horizons. Travel and adventure are often important aspects of their lives.

Challenges and Limitations: Despite their adventurous spirit, those with the core number 5 may face challenges with restlessness and a tendency to become easily distracted. They may struggle with commitment and staying focused on long-term goals.

As a final piece of advice, if you have the core number 5, embrace your adventurous nature and explore the world with an open mind. Use your adaptability to your advantage and seek experiences that bring you joy and fulfillment. While spontaneity is exciting, remember to find a balance between freedom and responsibility. Channel your dynamic energy into constructive endeavors and focus on nurturing long-term commitments and relationships that align with your values.
  `,
  num6:`Core Number 6:
  Compassionate and Nurturing: Individuals with the core number 6 are naturally compassionate and caring. They have a strong desire to help others and often take on nurturing roles in their relationships.

Responsible and Protective: Number 6 signifies a deep sense of responsibility and a protective nature. Those with this core number take care of their loved ones and are dedicated to providing support and stability.

Family-Oriented: Core Number 6 individuals prioritize family and home life. They find fulfillment in creating a harmonious and loving environment for their loved ones.

Service-Oriented: People with the core number 6 have a service-oriented approach to life. They are often drawn to professions and activities that involve helping others.

Diplomatic and Harmonious: Core number 6 represents diplomacy and the ability to bring harmony to challenging situations. Those with this core number are skilled at resolving conflicts and maintaining peace.

Artistic and Creative: Individuals with the core number 6 often have artistic and creative talents. They may express themselves through various forms of art, music, or other creative outlets.

Desire for Balance and Stability: Number 6 reflects a strong desire for balance and stability in life. Those with this core number strive to create a sense of equilibrium in their personal and professional relationships.

Challenges and Limitations: Despite their caring nature, those with the core number 6 may sometimes struggle with being overly involved in the lives of others, leading to neglecting their own needs. They may also face challenges in setting boundaries.

As a final piece of advice, if you have the core number 6, embrace your compassionate and nurturing qualities. Use your diplomatic skills to foster harmonious relationships and create a loving home environment. Remember to also take care of yourself and establish healthy boundaries to avoid feeling overwhelmed by the needs of others. Your ability to provide support and care will make a positive impact on the lives of those around you.
  `,
  num7:`Core Number 7:
  Introspective and Analytical: Individuals with the core number 7 are introspective and enjoy delving into the deeper aspects of life. They have a natural inclination for analysis and contemplation.

Intellectual and Philosophical: Number 7 signifies a strong intellectual capacity and a philosophical nature. Those with this core number enjoy seeking knowledge and understanding the mysteries of existence.

Spiritual and Mystical: Core Number 7 individuals often have a spiritual and mystical side. They may be drawn to esoteric or metaphysical subjects and have a keen interest in spirituality.

Reserved and Private: People with the core number 7 may appear reserved and private. They value their alone time and introspective moments.

Perfectionist and Detail-Oriented: Core number 7 represents a perfectionist nature and attention to detail. Those with this core number may be meticulous in their work and pursuits.

Seekers of Truth: Individuals with the core number 7 are seekers of truth and meaning. They are on a continuous quest for deeper understanding and insights.

Desire for Solitude and Reflection: Number 7 reflects a desire for solitude and reflection. Those with this core number may often withdraw from social interactions to contemplate and gain clarity.

Challenges and Limitations: Despite their intellect and depth, those with the core number 7 may sometimes struggle with overthinking or becoming overly critical of themselves and others. They may also experience challenges in expressing their emotions.

As a final piece of advice, if you have the core number 7, embrace your intellectual and introspective nature. Use your analytical skills to gain insights and wisdom. Embrace your spiritual side and continue your quest for knowledge and understanding. While it's essential to spend time in introspection, remember to find a balance between solitude and engaging with others. Your unique perspective and thirst for truth can contribute greatly to personal growth and the world around you.
  `,
  num8:`Core Number 8:
  Ambitious and Goal-Oriented: Individuals with the core number 8 are highly ambitious and driven to achieve their goals. They have a clear vision for success and are determined to make it a reality.

Strong Leadership Skills: Number 8 signifies strong leadership skills and the ability to take charge of situations. Those with this core number are natural decision-makers and can handle responsibility well.

Business-Minded: Core Number 8 individuals are often business-minded and have a talent for financial matters. They may be drawn to entrepreneurship and are skilled at managing finances.

Confident and Assertive: People with the core number 8 exude confidence and assertiveness. They are not afraid to take risks and are willing to step up to challenges.

Material Success and Abundance: Core number 8 represents material success and abundance. Those with this core number have the potential to achieve financial prosperity and enjoy the rewards of their hard work.

Determined and Resilient: Individuals with the core number 8 are determined and resilient. They can bounce back from setbacks and continue striving for success.

Balanced Approach: Number 8 reflects a balanced approach to life, where individuals can blend material and spiritual aspects harmoniously.

Challenges and Limitations: Despite their ambition and success-oriented nature, those with the core number 8 may sometimes struggle with a relentless pursuit of wealth, leading to neglecting personal relationships and well-being. They may also face challenges in finding true fulfillment beyond material achievements.

As a final piece of advice, if you have the core number 8, embrace your ambition and leadership qualities. Utilize your business acumen and financial skills to create prosperity for yourself and others. However, remember to strike a balance between pursuing success and maintaining meaningful connections with loved ones. Seek fulfillment not just in material achievements but also in personal growth and the contributions you make to the world. Use your confidence and determination to inspire and uplift those around you.
  `,
  num9:`Core Number 9:
  Compassionate and Empathetic: Individuals with the core number 9 are naturally compassionate and empathetic. They have a strong desire to help others and often feel deeply connected to the well-being of humanity.

Humanitarian and Philanthropic: Number 9 signifies a humanitarian spirit and a desire to make a positive impact on the world. Those with this core number are drawn to philanthropic endeavors and may engage in charitable work.

Generous and Selfless: Core Number 9 individuals are generous and selfless in their actions. They willingly give their time and resources to support those in need.

Idealistic and Visionary: People with the core number 9 often have a strong sense of idealism and a vision for a better world. They are inspired by noble causes and seek to create positive change.

Intuitive and Insightful: Core number 9 represents intuition and deep insights. Those with this core number may have a heightened sense of perception and can understand complex situations.

Endings and Transformation: Number 9 is also associated with endings and transformation. Those with this core number may experience significant life changes and personal growth.

Desire for Unity and Harmony: Core Number 9 individuals have a strong desire for unity and harmony among people. They believe in the power of love and compassion to bring people together.

Challenges and Limitations: Despite their altruistic nature, those with the core number 9 may sometimes struggle with feeling overwhelmed by the suffering of others. They may also face challenges in letting go of the past and moving forward.

As a final piece of advice, if you have the core number 9, embrace your compassionate and humanitarian nature. Use your selflessness to make a positive impact on the lives of others and the world around you. However, remember to take care of yourself and set healthy boundaries to avoid burnout. Trust your intuition and continue to seek personal growth and transformation. Your vision and idealism can inspire others to join you in creating a more harmonious and loving world.
  `,
  num11:`Core Number 11:
  Intuitive and Insightful: Individuals with the core number 11 possess strong intuition and insight. They have a deep understanding of the world and often have a sense of knowing beyond logical reasoning.

Spiritually Awakened: Number 11 signifies spiritual awakening and enlightenment. Those with this core number may have a profound connection to the spiritual realm and seek to understand the deeper meaning of life.

Idealistic and Visionary: Core Number 11 individuals are idealistic and visionary. They have big dreams and may feel a sense of purpose to bring positive change to the world.

Highly Sensitive: People with the core number 11 are highly sensitive to energy and emotions. They can easily pick up on the feelings of others and may be empathetic to the struggles of those around them.

Inspirational Leaders: Core number 11 represents inspirational leadership. Those with this core number have the potential to inspire and uplift others with their vision and charisma.

Challenging Journey: Master Numbers like 11 often come with significant challenges and responsibilities. Those with this core number may experience intense spiritual growth and personal transformation.

Spiritual Guides: Number 11 individuals may serve as spiritual guides or mentors to others. They have a natural ability to provide guidance and support to those on their spiritual journey.

Self-Discovery and Enlightenment: Core Number 11 individuals are on a continuous path of self-discovery and enlightenment. They may be drawn to spiritual practices and self-improvement.

Challenges and Limitations: Despite their spiritual gifts, those with the core number 11 may sometimes feel overwhelmed by their heightened sensitivity. They may also face challenges in fully embracing their spiritual potential.

As a final piece of advice, if you have the core number 11, embrace your intuitive and spiritually gifted nature. Trust your inner guidance and follow your unique path. Share your vision and insights with others to inspire positive change. However, remember to take time for self-care and grounding, as your sensitivity may sometimes feel intense. Use your spiritual gifts to bring light and wisdom to the world around you, and continue to explore and grow on your spiritual journey.
  `,
  num22:`Core Number 22:
  Master Builder: Individuals with the core number 22 are considered master builders. They have the ability to turn their dreams and visions into tangible realities through practical and strategic means.

Visionary and Ambitious: Number 22 signifies a strong sense of vision and ambition. Those with this core number have big dreams and a desire to create lasting and impactful changes in the world.

Practical and Methodical: Core Number 22 individuals combine their visionary qualities with practicality and methodical planning. They can devise detailed and effective strategies to achieve their goals.

Leadership and Influence: People with the core number 22 often have strong leadership skills and can influence others positively. They have the power to inspire and guide people towards a common purpose.

Transcending Boundaries: Core number 22 represents the ability to transcend boundaries and limitations. Those with this core number are not confined by conventional thinking and are open to innovative solutions.

Transformation and Success: Number 22 individuals often undergo significant personal transformation and growth. They have the potential for great success and achieving remarkable accomplishments.

Serving Humanity: Core Number 22 individuals have a profound desire to serve humanity and make a positive impact on a large scale. They may be drawn to humanitarian efforts and projects.

Challenging Path: Master Numbers like 22 come with considerable challenges and responsibilities. Those with this core number may face tests and obstacles on their journey to fulfill their purpose.

Harnessing Power and Responsibility: People with the core number 22 must learn to harness their power and accept the responsibility that comes with their abilities. Balancing their visionary nature with practicality is essential.

Manifestation and Achievement: Core Number 22 individuals have the unique gift of turning ideas into reality. They can manifest their dreams with determination and perseverance.

As a final piece of advice, if you have the core number 22, embrace your role as a master builder and visionary. Trust in your ability to create positive change and impact the lives of many. Remain focused on practicality while keeping your visionary spirit alive. Use your leadership skills to inspire and guide others towards a better future. Remember that with great power comes great responsibility, so always approach your endeavors with integrity and humility. Your potential for success and transformation is vast, so stay committed to your path of serving humanity and making a lasting difference in the world.
  `,
